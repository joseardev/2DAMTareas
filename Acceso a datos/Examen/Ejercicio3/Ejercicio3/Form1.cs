...
namespace Actividad7
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            miconexion = ConfigurationManager.ConnectionStrings["tiendaConnectionStringJOSE"].ConnectionString;
        ...
        private void btnInsertarFabricante_Click(object sender, EventArgs e)
        {
            ...
            while (registros.Read())
            {
                int.TryParse(registros["nombre"].ToString(), out codigo);
            }
        ...
        private void listaProductos_DoubleClick(object sender, EventArgs e)
        {
            ...
            while (registros.Read())
            {
                ...
                txtPrecio.Text = registros["Nombre"].ToString();
            }
